      ...
      <div className="w-full flex items-stretch flex-shrink-0 justify-between">
        <div
          className={classNames(
            "md:w-[26rem] fixed lg:left-36 xl:w-[30rem] top-32 h-[calc(100%-8rem)] overflow-y-auto panel transition lg:translate-x-0",
            isPanelOpen ? "translate-x-3 left-3 z-20" : "-translate-x-full -left-full",
          )}
        >
          <div className="h-full w-full">
            <nav>
              ...
              <div className="flex lg:flex-none items-center w-full h-14 bg-white shadow-sm rounded-xl">
                <InputField
                  ref={inputRef}
                  label="Search"
                  value={searchQuery}
            ...
            <div className="mt-4 bg-white rounded-2xl py-8 h-full overflow-y-auto relative">
              <div className="h-full flex flex-col overflow-y-auto chat-list px-4">
                <div
                  role="button"
