...
const JobCard: React.FC = () => (
  <motion.div className="w-[25rem] bg-white flex flex-col flex-shrink-0 flex-grow space-y-4 p-7 sm:p-9 rounded-xl ">
    ...
    <p className="text-lg font-normal text-gray-700">
      We are looking for an experienced mobile app developer who is proficient in React Native. The
      main responsibility will be to build a mobile app from....
    </p>
...
export const RequestedJobs: React.FC = () => {
  ...
  return (
    <div>
      <h1 className="text-xl lg:text-3xl font-bold capitalize text-[#4632A8]">requested jobs</h1>
