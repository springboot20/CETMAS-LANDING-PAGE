  ...
  return (
    <header
      className={classNames(
        "fixed top-0 right-0 h-20 sm:h-24 left-0 lg:left-36 bg-[#F9F9F9] z-20",
    ...
    >
      <div className="flex justify-between items-center h-full">
        <div>
          ...
          {pathname.split("/")[2] === "clients" && !(subRouteTitle === "profile") && (
          ...
          {pathname.split("/")[2] === "talents" && !(subRouteTitle === "profile") && (
            <div className="flex items-center space-x-3">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold capitalize text-gray-800">
                talents
              </h2>
        ...
        {pathname.split("/")[2] === "jobs" && !pathname.includes("jobs/:id") && (
          <div className="hidden lg:flex items-center space-x-3">
            <div className="hidden lg:block">
              <SearchField ref={searchInputRef} />
            </div>

            <SelectField className="bg-white shadow-sm rounded-xl focus:ring-0 h-14 w-48 lg:w-48 lg:h-16 px-5 text-base font-bold border-0 ring-[1px] ring-gray-300 capitalize">
              <option>newer</option>
